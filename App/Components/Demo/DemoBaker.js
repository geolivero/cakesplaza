      ...
      <StepSlider onStart={this.onStart} onSkip={this.onSkip} onBack={this.onBack} onReady={this.onSlideReady}>
        <View style={[styles.container]}>
           <View style={[styles.panel]}>
            <AnImg ref={'slideImage_1'} image={require('image!baker_slide_1')}/>
        ...
        <View style={[styles.container]}>
           <View style={[styles.panel]}>
            <AnImg ref={'slideImage_2'} image={require('image!baker_slide_2')}/>
...
Reageren op offertes…</Text>
        ...
        <View style={[styles.container]}>
           <View style={[styles.panel]}>
            <AnImg ref={'slideImage_3'} image={require('image!baker_slide_3')}/>
